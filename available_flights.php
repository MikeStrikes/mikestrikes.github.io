      ...
      <table style="width:50%;margin:auto;" id = "available_flights">
        ...
        for($j = 0;$j<=count($flights)-1;$j++){
          ...
          if($flights[$j]['departure_airport'] == $_GET['departure'] && $flights[$j]['arrival_airport'] == $_GET['destination'] ){
            ...
            $me = DepartureDate($_GET['departure_date'],$timezone,$timezone2,$flights[$j]['departure_time'],$flights[$j]['arrival_time']);
            echo "<td>";

            ?><input type="hidden" name="FlightTime" id = "nocheck"value="<?php DepartureDate($_GET['departure_date'],$timezone,$timezone2,$flights[$j]['departure_time'],$flights[$j]['arrival_time']) ?>" ><?php
        ...
        <div class="modal-content">
          ...
          <div id = "modal-bodyss"class="modal-body" style="font-weight:bold;">
            ...
            <div class="custom">
              ...
              <h4><?php echo $_POST['FlightTime']; ?></h4>
