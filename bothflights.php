...
$secondFlightHours = substr($_SESSION['fly_time_2'],0,-8);
$secondFlightMinutes = substr($_SESSION['fly_time_2'],2,-5);
...
<body style="background:#e8e8e8;">
  ...
  <center><h1>Confirm Flights</h1></center>
  <style media="screen">
  button {
  ...
  <div class="confirmation_box"style="height:320px;">
    <div class="inside-left" style="float:left;">
    ...
    <div class="inside-right">
      ...
      <hr>
      <text style="font-weight:bold;font-size:20px;"><?php echo $_SESSION['return_date']."          "; ?>               </text><text style="font-weight:bold;font-size:20px;padding-left:80px;"> <?php echo $_SESSION['arrival_city']; ?>, (<?php echo $_SESSION['destination']; ?>)
        - <?php echo $_SESSION['departure_city']; ?>, (<?php echo $_SESSION['departure_location']; ?>)</text>
        <div class="arround_inside_left">


          <div class="inside_left_detail">
            <span class = "bolded"><?php echo $_SESSION['departure_time_2']; ?></span>
            <span class = "bolded" style="padding-left:43%;"><?php echo $secondFlightHours."hr" ?><?php echo $secondFlightMinutes."m" ?></span><span class = "bolded" style="float:right;"><?php echo $_SESSION['arrival_time_2']; ?></span>
          </div>
          <div class="content_of_left"style="padding-top:50px;padding-left:50px;padding-right:50px;">
            <h3 style="float:left;"><?php echo $_SESSION['arrival_city']; ?></h3><h3 style="float:right;"><?php echo $_SESSION['departure_city']; ?></h3>
            <div class="">
              <center><span class = "bolded" style="font-size:16px;">Flight Cost: <?php echo $_SESSION['price_2']; ?>$</span></center>
              <hr style="margin-top:10px;">
            </div>
          </div>
        </div>
    ...
    <center><h1>Total Cost:<?php echo $_SESSION['price_1'] + $_SESSION['price_2'] ?>$</h1></center>
